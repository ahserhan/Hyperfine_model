...
def create_hamiltonian_nuclear():
    ...
    # Total Hamiltonian
    def H(bx, by, bz, rg, q, Aperp, Apar, L, alpha, beta, upsilon=0, A1=0, A2=0):
        """
        ...
        Parameters:
            ...
            A1: Off-diagonal hyperfine coupling (GHz), default=0
            A2: Off-diagonal hyperfine coupling (GHz), default=0
...
def solve_hamiltonian(B, theta, phi, q=params.q, Aperp=params.Aperp_gnd, 
                      Apar=params.Apar_gnd, L=params.L, alpha=0, beta=0, 
                      A1=params.A1_gnd, A2=params.A2_gnd):
    """
    ...
    Parameters:
        ...
        q: Orbital magnetic field susceptibility (default: params.q)
        Aperp: Perpendicular hyperfine coupling (GHz) (default: params.Aperp_gnd)
        Apar: Parallel hyperfine coupling (GHz) (default: params.Apar_gnd)
        L: Spin-orbit coupling strength (GHz) (default: params.L)
        alpha: Strain parameter in x direction (GHz)
        beta: Strain parameter in y direction (GHz)
        A1: Off-diagonal hyperfine coupling (GHz) (default: params.A1_gnd)
        A2: Off-diagonal hyperfine coupling (GHz) (default: params.A2_gnd)
    ...
    for i in range(len(B)):
        H_qobj = H(bx_vals[i], by_vals[i], bz_vals[i], params.rg, q, Aperp, Apar, L, alpha, beta, A1=A1, A2=A2)
...
def PLE_transitions(B, theta, phi, eta, alpha=0, beta=0, alpha_exc=0, beta_exc=0,
                     A1_gnd=params.A1_gnd, A2_gnd=params.A2_gnd, 
                     A1_exc=params.A1_exc, A2_exc=params.A2_exc):
    """
    ...
    Parameters:
        ...
        A1_gnd: Ground state off-diagonal hyperfine coupling A1 (GHz) (default: params.A1_gnd)
        A2_gnd: Ground state off-diagonal hyperfine coupling A2 (GHz) (default: params.A2_gnd)
        A1_exc: Excited state off-diagonal hyperfine coupling A1 (GHz) (default: params.A1_exc)
        A2_exc: Excited state off-diagonal hyperfine coupling A2 (GHz) (default: params.A2_exc)
    ...
    E, Eref, U, U_states, alignment = solve_hamiltonian(
        ...
        alpha, beta, A1=A1_gnd, A2=A2_gnd
    )
    ...
    E_exc, Eref_exc, U_exc, U_exc_states, alignment_exc = solve_hamiltonian(
        ...
        alpha_exc, beta_exc, A1=A1_exc, A2=A2_exc
    )
...
def PLE_spectrum(f_meas, B, theta, phi, eta, intensity=1.0, lw=0.080, 
    ...
    E, Eref, _, _, E_exc, Eref_exc, _, _, transition, _ = PLE_transitions(
        ...
        A1_gnd=A1_gnd, A2_gnd=A2_gnd, A1_exc=A1_exc, A2_exc=A2_exc
    )
